...
{ 
    public partial class Form_datos_sin_captura : Form
    {
        ...
        private void richTextBoxCurrency_TextChanged(object sender, EventArgs e)
        {

        }

        private void groupBox_SM_Enter_1(object sender, EventArgs e)
        {

        }

        private void richTextBoxnombre1_TextChanged(object sender, EventArgs e)
        {

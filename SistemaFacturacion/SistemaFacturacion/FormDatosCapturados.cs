...
namespace SistemaFacturacion
{
    public partial class FormDatosCapturados : Form
    {
        ...
        private void buttonCapturarDatos_Click(object sender, EventArgs e)
        {
            ...
            invoiceDate = dateFechaRegistro.ToString("MMMM,dd,yyyy");
            ...
            { return; }
                ...
                string query = string.Format("SELECT " +
                 ...
                 ", '' as TaxRate1 " +
                 ", '{25}' as Tax_Amount1 " +
                 "FROM [{26}$] where [F1]<>'' and [F1]<>'LineItemNumber'"
                 , invoiceCreditFlag
                 , invoiceDate
                 , invoiceNumber
            ...
            private void nuevo_form_llenado()
        {
            ...
            {
                if(richTextBox_invoiceCreditFlag == null)
                { MessageBox.Show("Por favor ingrese valores C credito o I Factura");
                return false;
                }
                if(richTextBox_InvoiceNumber == null)
                {
                    MessageBox.Show("Por favor ingrese el número de folio");
                    return false;
                }
                return true;
            }
